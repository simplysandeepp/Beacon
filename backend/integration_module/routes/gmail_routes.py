...
def gmail_login():
    ...
    # Save the code verifier and timestamp
    # flow.code_verifier is automatically generated by flow.authorization_url()
    _oauth_states[state] = {
        'timestamp': time.time(),
...
def gmail_oauth_redirect(request: Request):
    ...
    if isinstance(state_data, dict) and state_data.get('code_verifier'):
